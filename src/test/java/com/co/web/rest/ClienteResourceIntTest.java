...
import com.co.repository.ClienteRepository;
...
public class ClienteResourceIntTest {
    ...
    private static final Boolean DEFAULT_TIENE_CASINOS = false;
    private static final Boolean UPDATED_TIENE_CASINOS = true;
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente()
            ...
            .tieneCasinos(DEFAULT_TIENE_CASINOS);
        return cliente;
    }
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.isTieneCasinos()).isEqualTo(DEFAULT_TIENE_CASINOS);
    }
    ...
    public void getAllClientes() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tieneCasinos").value(hasItem(DEFAULT_TIENE_CASINOS.booleanValue())));
    }
    ...
    public void getCliente() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes/{id}", cliente.getId()))
            ...
            .andExpect(jsonPath("$.tieneCasinos").value(DEFAULT_TIENE_CASINOS.booleanValue()));
    }
    ...
    public void updateCliente() throws Exception {
        ...
        updatedCliente
            ...
            .tieneCasinos(UPDATED_TIENE_CASINOS);
        ...
        assertThat(testCliente.isTieneCasinos()).isEqualTo(UPDATED_TIENE_CASINOS);
    }
