...
import { MaquinaDialogComponent } from '../../../../../../main/webapp/app/entities/maquina/maquina-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Maquina Management Dialog Component', () => {
        let comp: MaquinaDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(MaquinaDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'maquinaListModification', content: 'OK'});
